...
<html>
	...
	<body>
		<div class="nav" role="navigation" data-role="navbar">
			<ul>
				<li><a class="home" href="${createLink(uri: '/')}"><g:message code="default.home.label"/></a></li>
				<li><g:link class="create" action="create"><g:message code="default.new.label" args="[entityName]" /></g:link></li>
				<li><g:link class="register" action="register"><g:message code="default.register.label" default="Register" /></g:link></li>
			</ul>
		</div>
			...
			<thead>
				...
				<g:each in="${userInstanceList}" status="i" var="userInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<%--<td>${fieldValue(bean: userInstance, field: "accountExpired")}</g:link></td>
