...
<link rel="shortcut icon"
	href="${resource(dir: 'images/gg', file: 'Slogo8.ico')}"
	type="image/x-icon">
<link rel="apple-touch-icon"
	href="${resource(dir: 'images/gg', file: 'Slogo8.png')}">
...
$( document ).on( "pageinit", "#homePage", function() {
	...
	function loaded() {
		setTimeout(function () {
			myScroll = $("#content").niceScroll({cursorcolor:"#FBAA18"});
		}, 100);
	}
...
<body>
	<div data-role="page" id="homePage" data-theme="e">
		<div data-role="header" data-position="fixed">
			<h1><img src="${createLink(controller:'File', action:'show', params:[photoUrl:"logoALL.png"])}" width="120" />廚房滴雞精</h1>
			<div id="narbarList">
